...
| **Task Name and Time Including Interrupts** | **Initiation Time – Tau (ms)** | **Execution Time – Ti ()** | **Priority Assigned** |
| --- | --- | --- | --- |
| scanKeys() | 50 | 82.0 | 2 |
...
![](RackMultipart20230315-1-9rm64j_html_c53abefa73c12d58.jpg)
