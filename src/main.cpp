...
int16_t wavearr[3][90] = {{0,4,8,13,17,22,26,30,35,39,43,47,52,56,60,63,67,71,75,78,82,85,88,92,95,98,100,103,106,108,110,113,115,116,118,120,121,123,124,125,126,126,127,127,127,128,127,127,127,126,126,125,124,123,121,120,118,116,115,113,110,108,106,103,100,98,95,92,88,85,82,78,75,71,67,63,60,56,52,47,43,39,35,30,26,22,17,13,8,4},
...
//KnobValueTracking
volatile uint8_t knobCount[4] = {0,0,2,0};
volatile uint8_t prevKnob[4] = {0,0,0,0};

//Tracked Pressed Keys
volatile uint16_t keyVal = 4095;
